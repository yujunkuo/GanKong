...
//    @IBOutlet var asleepLabel: UILabel!
    ...
    private func updateHealthInfo() {
        homeVC.loadAndDisplayAgeSexAndBloodType()
        print("Age&Sex&BloodType Done")
        homeVC.loadAndDisplayMostRecentWeight()
        print("Weight Done")
        homeVC.loadAndDisplayMostRecentHeight()
        print("Height Done")
        homeVC.loadAndDisplayMostRecentHeartRate()
        print("HR Done")
        homeVC.loadAndDisplayMostRecentStep()
        print("Step Done")
        homeVC.loadAndDisplayMostRecentSleepAnalysis()
        print("Sleep Done")
    }
